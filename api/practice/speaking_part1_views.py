...
from api.skills.speaking.part1 import (
    skill_speaking_part1_generate,
    skill_speaking_part1_evaluate,
    skill_speaking_part1_summary,
)
...
def generate_part1_questions(request):
    try:
        ...
        system_instruction = {
            "role": "system",
            "content": skill_speaking_part1_generate()
        }
...
def evaluate_part1_answer(request):
    try:
        ...
        system_instruction = {
            "role": "system",
            "content": skill_speaking_part1_evaluate(
                question, user_answer, dynamic_q_instruction,
...
def generate_part1_summary(request):
    try:
        ...
        system_instruction = {
            "role": "system",
            "content": skill_speaking_part1_summary(history_text)
        }
