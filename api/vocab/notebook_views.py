...
from api.models import Notebook, NotebookWord, NotebookWordTag, Word, VocabBook, WordBookMembership
...
class NotebookWordListView(APIView):
    ...
    # 鈹€鈹€ manual (original single-word logic) 
    ...
    # 鈹€鈹€ bulk import from vocab book 
